...
class LimitPlot(PlotApp):
    ...
    def __call__(self,options,args):
        ...
        flist = [ "%s/higgsCombineMonoHgg%s_sig_ZpBaryonicCombined.%s.ZpBaryonic_mZP%s.root" % (options.input_dir,options.suffix, options.method,options.mZP)]
  ...
  #      style_utils.apply( gr_15, [["colors",ROOT.kMagenta],["SetLineStyle",9],["SetName","gr_pho"]]+expectedStyle )
        ...
        title=ROOT.TString()
        title="Comparison_ZpBaryonic_%s" % options.mZP
