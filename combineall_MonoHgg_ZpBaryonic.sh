...
cd $folder
echo $folder
label=MonoHgg${suffix}_sig_ZpBaryonic
...
hadd -f higgsCombine${label}Combined.$method.ZpBaryonic_mZP${mZ}.root higgsCombine${label}_mZP${mZ}_mChi*.Asymptotic.mH*.root 
done
